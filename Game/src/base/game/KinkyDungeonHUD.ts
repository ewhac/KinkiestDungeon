...
function KDDrawMinimap(MinimapX: number, MinimapY: number) {
	if (kdminimap.visible) {
		...
		KDBaseBlack, undefined, undefined, {zIndex: zIndex-2, alpha: 0., hotkeyLabel: KDHotkeyToText(KinkyDungeonKeyMap[0]), hotkeyPress: KinkyDungeonKeyMap[0]});
...
function KDDrawBuffIcons(minXX: number, minYY: number, statsDraw: Record<string, statInfo>, side: boolean) {
	...
	{
		zIndex: 10,
		hotkeyLabel: KDHotkeyToText(KinkyDungeonKeyToggle[11]),
